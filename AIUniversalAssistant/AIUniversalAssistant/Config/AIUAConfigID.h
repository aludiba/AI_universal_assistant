...
#define AIUA_APPID               @"5783441"      // AppID
#define AIUA_SPLASH_AD_SLOT_ID   @"895060092"   // 开屏代码位
#define AIUA_REWARD_AD_SLOT_ID   @"978136707"   // 激励视频代码位
...
// 激励视频奖励配置
// AIUA_REWARD_DAILY_LIMIT:
//  - >0: 每日最大观看次数（如 4 表示每天最多 4 次）
//  - <=0: 不限制次数
#define AIUA_REWARD_DAILY_LIMIT  5
#define AIUA_REWARD_WORDS_PER_WATCH 50000
